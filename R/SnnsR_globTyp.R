...
SnnsR_entryTypesNameTable <-  matrix(c(
"UNUSED_SYM",         0,
"UNIT_SYM",           1,
"SITE_SYM",           2,
"FTYPE_UNIT_SYM",     3)
...
SnnsR_constantsNetworkAnalyzer <-  matrix(c(     
"MAX_ARRAY_SIZE", 5000,
"NA_ERROR_LIN",      1,
"NA_ERROR_SQR",      2,
"NA_ERROR_SU",       3)
...
SnnsR_copyModes <-  matrix(c("INPUTS_AND_OUTPUTS",     1,
"ONLY_INPUTS",            2,
"ONLY_OUTPUTS",           3,
"ONLY_UNIT",              4)
,ncol=2,byrow=TRUE)

SnnsR_topologicalUnitTypes <-
...
SnnsR_unitInputTypes <-  matrix(c(
"NO_INPUTS",      0,
"SITES",          1,
"DIRECT_LINKS",   2)
        ,ncol=2,byrow=TRUE)

SnnsR_patternUpdateModes <-  matrix(c(
"OUTPUT_NOTHING",  1,
"OUTPUT_ACT",      2,
"OUTPUT_OUT",     3)      
                ,ncol=2,byrow=TRUE)
