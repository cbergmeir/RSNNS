...
/*extern "C" krui_err  krui_setUnitOutPyFunc(int unit_no, PyObject *outfunc);*/
...
extern "C" void      krui_getMemoryManagerInfo(int *unit_bytes, int *site_bytes, 
...
extern "C" krui_err  krui_setUnitDefaults(FlintTypeParam act, FlintTypeParam bias, 
...
extern "C" float     krui_NA_Error(int currentPattern, int error_unit, int error, 
			       bool ave);
